...
def get_sql_data_reader(
    ...
    try:
        ...
        # DIFFERENCE: the sibling returns a DbDataReader and disposes the command that created
        # it. Here the cursor is both, so it is returned as it is - and whoever writes it into
        # a table closes it, exactly as Write-SqlTable disposes the reader it was handed.
